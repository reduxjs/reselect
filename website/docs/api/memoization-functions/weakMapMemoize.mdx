...
Prior to `weakMapMemoize`, you had this problem:
  ...
  <!-- START: weakMapMemoize/weakMapMemoize-problem.ts -->
...
```ts title="weakMapMemoize/weakMapMemoize-problem.ts"
...
```js title="weakMapMemoize/weakMapMemoize-problem.js"
import { createSelector } from 'reselect'
...
```
  ...
  <!-- END: weakMapMemoize/weakMapMemoize-problem.ts -->
...
Starting in 5.0.0, you can eliminate this problem using `weakMapMemoize`.
  ...
  <!-- START: weakMapMemoize/weakMapMemoize-solution.ts -->
...
```ts title="weakMapMemoize/weakMapMemoize-solution.ts"
...
```js title="weakMapMemoize/weakMapMemoize-solution.js"
import { createSelector, weakMapMemoize } from 'reselect'
...
```
  ...
  <!-- END: weakMapMemoize/weakMapMemoize-solution.ts -->
