...
without bound — and because it sits in front, it returns cached results before the
bounded cache is ever consulted. Pass `maxSize` in **both** options:
