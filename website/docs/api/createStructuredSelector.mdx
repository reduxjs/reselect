...
<!-- START: createStructuredSelector/typedStructuredSelectorCreator.ts -->
...
```ts title="createStructuredSelector/typedStructuredSelectorCreator.ts"
...
```js title="createStructuredSelector/typedStructuredSelectorCreator.js"
import { createStructuredSelector } from 'reselect'

const typedStructuredSelectorCreator = createStructuredSelector
...
```
  ...
  <!-- END: createStructuredSelector/typedStructuredSelectorCreator.ts -->
