...
| `selectorCreator?`     | A custom selector creator function. It defaults to [`createSelector`](./createSelector.mdx). |
...
| Name                   | Description                                                                                                                                            |
| :--------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------- |
| `InputSelectorsObject` | The shape of the [input selectors](../introduction/getting-started.mdx#input-selectors) object.                                                        |
...
| `ArgsMemoizeFunction`  | The type of the memoize function that is used to memoize the arguments passed into the generated structured selector. It defaults to `weakMapMemoize`. |
