...
This way if the [result function](../introduction/getting-started.mdx#result-function) returns an empty array twice in a row, your component will not re-render due to a stable empty array reference:
