...
Enhances Reselect selectors by wrapping [`createSelector`](./api/createSelector.mdx) and returning a memoized collection of selectors indexed with the cache key returned by a custom resolver function.
