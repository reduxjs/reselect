declare module 'reselect' {
  declare type Selector<TInput, TProps, TOutput> = (state: TInput, props: ?TProps, ...rest: Array<any>) => TOutput;
  ...
  declare function createStructuredSelector(inputSelectors: any, selectorCreator?: any): any;

  declare type EqualityChecker = <T>(arg1: T, arg2: T) => boolean;
  declare function defaultMemoize<S,P,R>(fun: Selector<S,P,R>) : Selector<S,P,R>;
  declare function createSelectorCreator<S,P,R>(memoize: Selector<S,P,R>, ...memoizeOptions: any[]): any;
}
