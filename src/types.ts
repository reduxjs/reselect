...
/**
 * Represents a curried {@linkcode OutputSelector OutputSelector}.
 *
 * @template InputSelectors - The type of the input selectors.
 * @template Result - The type of the result returned by the `resultFunc`.
 ...
 * @public
 */
export type CurriedOutputSelector<
  InputSelectors extends SelectorArray = SelectorArray,
  Result = unknown,
  MemoizeFunction extends UnknownMemoizer = typeof defaultMemoize,
  ArgsMemoizeFunction extends UnknownMemoizer = typeof defaultMemoize
 ...
 *
 * @template FunctionType The original function type.
 *
 * @internal
 */
export type Curried<FunctionType extends (...params: any[]) => any> = (
  ...params: DropFirstParameter<FunctionType>
) => (state: Parameters<FunctionType>[0]) => ReturnType<FunctionType>
