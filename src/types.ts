...
> {
   ...
   * {@linkcode CreateSelectorOptions.memoize memoize} function.
  ...
  /**
   * Optional configuration options for the
   * {@linkcode CreateSelectorOptions.argsMemoize argsMemoize} function.
   * These options are passed to the
   * {@linkcode CreateSelectorOptions.argsMemoize argsMemoize} function
   * as the second argument.
   *
...
/**
 * The additional fields attached to the output selector
 * generated by `createSelector`.
 *
 * **Note**: Although {@linkcode CreateSelectorOptions.memoize memoize}
 * and {@linkcode CreateSelectorOptions.argsMemoize argsMemoize} are
 * included in the attached fields,
 * the fields themselves are independent of the type of
 * {@linkcode CreateSelectorOptions.memoize memoize} and
 * {@linkcode CreateSelectorOptions.argsMemoize argsMemoize} functions.
 * Meaning this type is not going to generate additional fields based on
 * what functions we use to memoize our selectors.
 *
 * _This type is not to be confused with
 * {@linkcode ExtractMemoizerFields ExtractMemoizerFields}._
 *
