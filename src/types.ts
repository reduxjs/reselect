import type { List, Any, Misc } from 'ts-toolbelt'
...
> = Selector<unknown, Result, MergeParameters<S>> &
...
type AllArrayKeys<A extends any[]> = A extends any
  ? {
      [K in keyof A]: K
    }[number]
  : never

type Mapped<A extends any[]> = AllArrayKeys<A> extends infer Keys
  ? A extends any
    ? {
