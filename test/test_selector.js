...
suite('selector', () => {
  ...
  test('custom memoize', () => {
    ...
    assert.equal(selector.memoize.cache.has('1-2'), true)
    assert.equal(selector.memoize.cache.has('1-3'), true)
    assert.equal(selector.memoize.cache.has('2-3'), true)
    selector.memoize.cache.clear()
    assert.equal(selector.memoize.cache.has('1-2'), false)
    assert.equal(selector.memoize.cache.has('1-3'), false)
    assert.equal(selector.memoize.cache.has('2-3'), false)
