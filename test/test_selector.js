...
suite('selector', () => {
  ...
  test('custom memoize', () => {
    ...
    assert.isTrue(selector.memoize.cache.has('1-2'))
    assert.isTrue(selector.memoize.cache.has('1-3'))
    assert.isTrue(selector.memoize.cache.has('2-3'))
    selector.memoize.cache.clear()
    assert.isFalse(selector.memoize.cache.has('1-2'))
    assert.isFalse(selector.memoize.cache.has('1-3'))
    assert.isFalse(selector.memoize.cache.has('2-3'))
