 ...
 * the published artifact (`dist/reselect.mjs` and friends).
 *
 * RTK's `examples/publish-ci/*` exists to record which of our several published
 ...
 * debugging into Reselect still resolves to the original TypeScript.
 */
async function main() {
