...
* [FAQ](#faq)
  ...
  * [Почему мой селектор не не производит вычисления, когда изменяется входное состояние?](#q-почему-мой-входной-селектор-не-производит-вычисления-когда-изменяется-входное-состояние)
